      ...
      <main className="flex flex-col gap-8 items-center">
        ...
        <div className="grid grid-cols-3 items-center justify-center gap-6 p-5 rounded-md shadow-inner">
          <Link href="https://landing-booking.vercel.app/" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" stroke-linejoin="round" stroke-width="4" rx="3"/><path stroke="#058055" stroke-width="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
