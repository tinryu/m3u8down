  ...
  return (
    <div className="grid grid-rows items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 items-center">
        ...
        <div className="flex flex-col gap-4 p-4 items-center justify-center bg-white w-full h-[150px] ring-1 ring-green-500 shadow-md rounded-md font-mono text-green-400 text-center text-xs pl-5">
          <p>The cloud slowly make some tiny rains, I stay calm see cross line</p>
          <p>typing click ... tap tap..</p>
          <p>typing tap tap..</p>
        </div>
        <h4 className="font-mono font-semibold">Some product i makes</h4>
        <div className="grid grid-cols-3 items-center justify-center gap-6 p-5 rounded-md shadow-inner">
          <Link href="https://landing-booking.vercel.app/" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" strokeLinejoin="round" strokeWidth="4" rx="3"/><path stroke="#058055" strokeWidth="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
            <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium text-green-600">Landing booking</span>
          </Link>
          <Link href="https://white-out.vercel.app/" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" strokeLinejoin="round" strokeWidth="4" rx="3"/><path stroke="#058055" strokeWidth="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
            <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium text-green-600">whiteOutAd</span>
          </Link>

          <Link href="" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" strokeLinejoin="round" strokeWidth="4" rx="3"/><path stroke="#058055" strokeWidth="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
            <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium text-green-600">youtube audio</span>
          </Link>
          <Link href="" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" strokeLinejoin="round" strokeWidth="4" rx="3"/><path stroke="#058055" strokeWidth="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
            <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium text-green-600">svelte chat</span>
          </Link>
          <Link href="" className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><g fill="none"><rect width="40" height="32" x="4" y="8" stroke="#058055" strokeLinejoin="round" strokeWidth="4" rx="3"/><path stroke="#058055" strokeWidth="4" d="M4 11a3 3 0 0 1 3-3h34a3 3 0 0 1 3 3v9H4z"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 10 14)"/><circle r="2" fill="#058055" transform="matrix(0 -1 -1 0 16 14)"/></g></svg>
            <span className="inline-flex items-center rounded-md px-2 py-1 text-xs font-medium text-green-600">project in future :D</span>
          </Link>
        </div>
      </main>
